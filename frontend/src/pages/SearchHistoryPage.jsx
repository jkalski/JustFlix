            ...
            <div className='max-w-6xl mx-auto px-4 py-8'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                    ...
                    {searchHistory.map((entry) => (
                        <div
                            key={entry.id}
                            className='bg-gray-800 p-4 px-6 rounded flex items-start '
                        >
                            ...
                            <div className='flex items-center space-x-2 ml-auto'>
                                <span
                                    className={`py-1 px-3 text-center rounded-full text-sm 
                                ...
                                <Trash
                                    className='w-6 h-6 cursor-pointer hover:fill-red-600 ml-4 hover:text-red-600'
