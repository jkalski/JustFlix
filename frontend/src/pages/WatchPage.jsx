                ...
                {similarContent.length > 0 && (
                    <div className='mt-12 max-w-5xl mx-auto relative'>
                        ...
                        <div className='flex overflow-x-scroll scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
                            ...
                            <ChevronRight
                                className="absolute top-1/2 -translate-y-1/2 right-5 md:right-25 flex items-center justify-center 
                                size-12 rounded-full bg-black bg-opacity-50 hover:bg-opacity-75 text-white z-10"
                                onClick={scrollRight}
                            />

                            <ChevronLeft
                                className="absolute top-1/2 -translate-y-1/2 left-5 md:left-25 flex items-center justify-center 
                                size-12 rounded-full bg-black bg-opacity-50 hover:bg-opacity-75 text-white z-10"
                                onClick={scrollLeft}
